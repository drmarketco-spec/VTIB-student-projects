...
<head>
  ...
  <style>
    ...
    .stat-box:hover { transform: translateY(-8px); box-shadow: var(--sh-lg); }
    .stat-number {
      font-family: var(--font-h);
      font-size: 3.2rem; font-weight: 800;
      color: var(--em); display: block; margin-bottom: 10px;
    }
    .stat-label { font-size: 1rem; color: var(--muted); font-weight: 600; }

    /* ── Our story section ── */
    .story-section { padding: 100px 0; background: var(--surface); }
    .story-content { max-width: 860px; margin: 0 auto; }

    .section-eyebrow {
      color: var(--em); font-family: var(--font-b);
    ...
    .story-highlight p {
      ...
      font-style: italic; color: var(--em-dark);
      font-weight: 600; line-height: 1.8;
    }
    [data-theme="dark"] .story-highlight p { color: #6ee7b7; }

    /* ── Mission & vision cards ── */
    .mission-vision-section { padding: 100px 0; background: var(--bg); }
    ...
    .vision-box { border-color: var(--gold); }
    .vision-box:hover { box-shadow: 0 25px 70px rgba(240,180,41,.2); }

    .mission-icon, .vision-icon {
      font-size: 3.5rem; margin-bottom: 22px; display: block;
    }
    ...
    /* ── Core values grid ── */
    .values-section { padding: 100px 0; background: var(--surface); }
    .value-card {
      background: var(--bg-2);
      padding: 46px 36px;
      border-radius: var(--r); text-align: center; height: 100%;
      box-shadow: var(--sh); border: 1px solid var(--border);
      transition: transform var(--ease), box-shadow var(--ease), border-color var(--ease);
    }
    .value-card:hover { transform: translateY(-8px); box-shadow: var(--sh-lg); border-color: var(--em); }
    .value-icon {
    ...
    .value-card p { color: var(--muted); line-height: 1.75; font-size: .95rem; margin: 0; }
    ...
    .team-member h4 {
      ...
      font-weight: 800; margin-bottom: 6px; color: var(--text);
    }
    .team-role { color: var(--em); font-weight: 700; margin-bottom: 10px; font-size: .9rem; }
    .team-bio { color: var(--muted); max-width: 300px; margin: 0 auto; line-height: 1.7; font-size: .9rem; }
    ...
    .cta-section h2 {
      font-family: var(--font-h);
      font-size: clamp(2rem, 4vw, 3rem);
      font-weight: 800; margin-bottom: 18px; color: #fff;
    }
    .cta-section p {
      font-size: 1.15rem; margin-bottom: 36px;
      opacity: .9; max-width: 660px;
    ...
    .cta-btn:hover { transform: translateY(-4px); box-shadow: 0 16px 40px rgba(0,0,0,.3); color: var(--em); }
    ...
    .site-footer .tagline { font-size: .88rem; color: rgba(255,255,255,.5); max-width: 260px; line-height: 1.65; }
    ...
    .site-footer .footer-socials a:hover { background: var(--em); border-color: var(--em); color: #fff; transform: translateY(-3px); }
    ...
    .site-footer .footer-col ul { list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 9px; }
    .site-footer .footer-col ul li a {
      font-size: .85rem; color: rgba(255,255,255,.5);
      transition: color .2s, padding-left .2s; display: inline-block; text-decoration: none;
    }
    ...
    @media (max-width: 768px) {
      ...
      .mission-box, .vision-box { margin-bottom: 24px; }
      .team-photo { width: 160px; height: 160px; font-size: 3.5rem; }
    }
  ...
  <div class="topbar">
    <div class="container topbar-inner">
      <div class="topbar-contacts">
        ...
        <a href="/cdn-cgi/l/email-protection#9df4f3fbf2ddebe9f4ffb3fef2f0"><i class="bi bi-envelope-fill"></i><span class="__cf_email__" data-cfemail="1b72757d745b6d6f727935787476">[email&#160;protected]</span></a>
      </div>
  ...
  <div class="container">
    <div class="navbar-row">
      ...
      <ul class="main-nav" id="mainNav">
        ...
        <li><a href="vtib-about.html" class="active">About</a></li>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-4" data-aos="fade-up" data-aos-delay="0">
        <div class="value-card">
          ...
          <p>We celebrate creativity and encourage students to push boundaries, experiment fearlessly, and create solutions that make a difference.</p>
        </div>
      </div>
      ...
      <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
        <div class="value-card">
          ...
          <p>A platform built by students, for students. Our community thrives on collaboration, mutual support, and collective success.</p>
        </div>
      </div>
      ...
      <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
        <div class="value-card">
          ...
          <p>We maintain the highest standards of honesty, transparency, and fairness in all transactions and interactions.</p>
        </div>
      </div>
      ...
      <div class="col-md-4" data-aos="fade-up" data-aos-delay="0">
        <div class="value-card">
          ...
          <p>We strive for quality in every project, every interaction, and every feature we build on our platform.</p>
        </div>
      </div>
      ...
      <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
        <div class="value-card">
          ...
          <p>We believe in continuous learning, embracing challenges, and turning every experience into an opportunity for growth.</p>
        </div>
      </div>
      ...
      <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
        <div class="value-card">
          ...
          <h4>Student-First</h4>
          <p>Every decision we make prioritises the needs, success, and wellbeing of our student creators and buyers.</p>
        </div>
      </div>
    ...
    <div class="row justify-content-center g-4">
      ...
      <div class="col-md-4" data-aos="fade-up" data-aos-delay="0">
        <div class="team-member">
          ...
          <p class="team-bio">Computer Science student passionate about building platforms that empower student creators.</p>
        </div>
      </div>
      ...
      <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
        <div class="team-member">
          ...
          <p class="team-bio">Passionate about building connections and fostering collaboration among student innovators.</p>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-4">
        <div class="footer-col">
          ...
          <ul>
            ...
            <li><a href="/cdn-cgi/l/email-protection#4c25222a230c3a38252e622f2321"><i class="bi bi-envelope-fill me-1"></i><span class="__cf_email__" data-cfemail="650c0b030a2513110c074b060a08">[email&#160;protected]</span></a></li>
  ...
  <div class="footer-bottom">
    <div class="container">
      <div class="footer-bottom-inner">
        <p>© <strong style="color:rgba(255,255,255,.6)">VTIB Marketplace</strong>. Built with ❤️ by students, for students.</p>
